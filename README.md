...
Over 3 years of experience providing high-volume technical support with a strong focus on software troubleshooting and process optimization, combined with hands-on experience designing and shipping production software.
...
`React` `Vite` `Flask` `Weaviate` `RAG` `Vector Search`
...
**⚽ [Bet506 — Sports Betting Platform](https://github.com/Davidcm2803/Proyecto_Apuestas)**
...
`.NET Core` `C#` `MySQL` `TheSportsDB API`
...
[![View all projects](https://img.shields.io/badge/View_all_projects-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Davidcm2803?tab=repositories)
